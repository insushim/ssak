...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">ISW 글쓰기 도우미</span>
          </div>
          <div className="flex items-center gap-4">
            <a href="#features" className="text-gray-600 hover:text-gray-900 hidden md:block">기능</a>
            <a href="#comparison" className="text-gray-600 hover:text-gray-900 hidden md:block">비교</a>
            <a href="#pricing" className="text-gray-600 hover:text-gray-900 hidden md:block">요금</a>
            <Link to="/login" className="text-emerald-600 font-medium hover:text-emerald-700">로그인</Link>
            <a href="#contact" className="px-4 py-2 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 transition-colors">
              도입 문의
            </a>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                6+1 Trait Writing 기반의 전문적인 평가 시스템.<br/>
                교사의 피드백 부담은 줄이고, 학생의 글쓰기 실력은 높이세요.
              </p>
              <div className="flex flex-wrap gap-4">
                <a href="#contact" className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-bold text-lg hover:from-emerald-600 hover:to-teal-600 transition-all shadow-lg shadow-emerald-500/30">
                  무료 체험 신청
                </a>
                <button
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                세계적으로 검증된 글쓰기 평가 프레임워크를 적용.
                아이디어, 구성, 어휘, 문장 유창성, 규범 등 6가지 영역별 상세 피드백 제공.
              </p>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                기준 점수(70점) 이상 받을 때까지 무제한 수정 가능.
                "틀렸다"가 아닌 "성장 중"이라는 메시지를 전달합니다.
              </p>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                ChatGPT 등으로 생성한 글을 자동 감지.
                표절 감지(50% 이상 유사도 차단)로 학습의 진정성을 보장합니다.
              </p>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-sky-50 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                학급별 과제 배정, 진도 확인, 일괄 학생 계정 생성.
                교사가 직접 최종 점수를 조정하고 피드백을 추가할 수 있습니다.
              </p>
            ...
            <table className="w-full bg-white rounded-2xl shadow-lg overflow-hidden">
              <thead>
                <tr className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white">
                  ...
                  <th className="px-6 py-4 text-center text-white/80">EBS 온라인클래스</th>
                  <th className="px-6 py-4 text-center text-white/80">클래스팅</th>
                  <th className="px-6 py-4 text-center text-white/80">아이스크림</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                <tr>
                  <td className="px-6 py-4 font-medium">AI 글쓰기 평가</td>
                  <td className="px-6 py-4 text-center text-emerald-600 font-bold">✓ 6+1 Trait</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                  <td className="px-6 py-4 text-center text-gray-400">제한적</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="px-6 py-4 font-medium">학년별 맞춤 평가</td>
                  <td className="px-6 py-4 text-center text-emerald-600 font-bold">✓ 초1~고3</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                  <td className="px-6 py-4 text-center text-gray-400">초등만</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 font-medium">무제한 고쳐쓰기</td>
                  <td className="px-6 py-4 text-center text-emerald-600 font-bold">✓</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                  <td className="px-6 py-4 text-center text-gray-400">✗</td>
                </tr>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-center text-emerald-600 font-bold">✓ 전문</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-center text-emerald-600 font-bold">30만원~</td>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-emerald-300 transition-colors">
              ...
              <a href="#contact" className="block w-full py-3 text-center border-2 border-emerald-500 text-emerald-600 rounded-xl font-bold hover:bg-emerald-50 transition-colors">
                무료로 시작하기
              </a>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl p-8 text-white transform scale-105 shadow-xl">
              ...
              <a href="#contact" className="block w-full py-3 text-center bg-white text-emerald-600 rounded-xl font-bold hover:bg-emerald-50 transition-colors">
                도입 문의하기
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-emerald-300 transition-colors">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-gray-900">교육청/대규모</h3>
                <div className="mt-4">
      ...
      {/* 문의 섹션 */}
      <section id="contact" className="py-20 px-4 bg-gradient-to-br from-emerald-500 to-teal-600">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            무료 체험을 시작하세요
          </h2>
          <p className="text-xl text-emerald-100 mb-8">
            30일간 모든 기능을 무료로 사용해보세요.<br/>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#features" className="hover:text-white">기능 소개</a></li>
                <li><a href="#pricing" className="hover:text-white">요금제</a></li>
                <li><Link to="/login" className="hover:text-white">로그인</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-4">고객 지원</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="#contact" className="hover:text-white">도입 문의</a></li>
                <li><a href="mailto:support@isw-writing.com" className="hover:text-white">이메일 문의</a></li>
              </ul>
            </div>
            <div>
      ...
      {showDemo && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" onClick={() => setShowDemo(false)}>
          <div className="bg-white rounded-2xl max-w-4xl w-full p-2" onClick={e => e.stopPropagation()}>
