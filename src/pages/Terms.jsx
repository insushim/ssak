    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-gray-500 mb-8">시행일: 2026년 1월 1일</p>
          ...
          <div className="prose prose-emerald max-w-none text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="leading-relaxed">
                이 약관은 ISW 글쓰기 도우미(이하 "서비스")의 이용조건 및 절차,
                이용자와 서비스 제공자의 권리, 의무, 책임사항 등을 규정함을
                목적으로 합니다.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-6 space-y-2">
                <li>
                  <strong>"서비스"</strong>란 AI 기반 글쓰기 학습 및 평가
                  서비스를 말합니다.
                </li>
                <li>
                ...
                <li>
                  <strong>"학교"</strong>란 서비스를 도입하여 사용하는
                  교육기관을 말합니다.
                </li>
                <li>
                  <strong>"콘텐츠"</strong>란 이용자가 작성한 글, 평가 결과 등을
                  말합니다.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  학생 계정은 담당 교사가 생성하며, 학교의 승인 하에 이용됩니다.
                </li>
                <li>
                  만 14세 미만 학생의 경우, 학교장 또는 법정대리인의 동의가
                  필요합니다.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  서비스는 글쓰기 평가 및 서비스 개선 목적으로만 콘텐츠를
                  활용합니다.
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-6 space-y-2">
                <li>
                  AI 평가는 참고용이며, 최종 평가는 교사의 판단에 따릅니다.
                </li>
                <li>AI의 평가 결과가 항상 정확하지 않을 수 있습니다.</li>
                <li>
                  AI 평가 결과에 대한 이의는 담당 교사에게 제기할 수 있습니다.
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="leading-relaxed mt-4">
                서비스 중단 시 사전에 공지하며, 불가피한 경우 사후 공지할 수
                있습니다.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  이용자의 귀책사유로 인한 손해에 대해서는 책임지지 않습니다.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  협의가 이루어지지 않을 경우, 관할 법원에 소를 제기할 수
                  있습니다.
                </li>
